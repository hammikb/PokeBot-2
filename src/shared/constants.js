...
export const IPC = {
  ...
  TASKS_FOCUS_CHECKOUT: 'tasks:focus-checkout',
  ...
  QUEUE_SET_AUTO_CHECKOUT: 'queue:set-auto-checkout',
  QUEUE_REMOVE: 'queue:remove',
  QUEUE_POLL_NOW: 'queue:poll-now',
  QUEUE_SESSION_REFRESH: 'queue:session-refresh',
  QUEUE_SCAN_JOIN: 'queue:scan-join',
